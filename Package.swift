...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            name: "MTAnalytics",
            url: "https://packages.a.mts.ru/repository/apple-sdk/ios-sdk/build/MTAnalytics-Static-5.1.5-testing.zip",
            checksum: "fc357e7361bc697c67ff97e7a3aabc225090ff940150bec2fc998afee145a50f"
         )
    ]
)
